"""Export to LabelMe JSON via the unified writer."""
...
@dataclass
class LabelMeJsonExportOptions:
    out_dir: Path
...
def export_labelme_json(
    ...
    result = export_samples(ss, "labelme", fo, progress_cb=progress_cb)
