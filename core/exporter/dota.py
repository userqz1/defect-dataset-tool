"""Export to DOTA-style oriented detection labels via the unified writer."""
...
def export_dota(
    ...
    result = export_samples(ss, "dota", fo, progress_cb=progress_cb)
    return ExportReport(
