...
PRESETS: tuple[AnnotationPreset, ...] = (
    ...
    AnnotationPreset(
        id="semantic_seg",
        display_name="语义分割",
        description="多边形像素分割,导出为 COCO-seg / Mask-PNG",
        task_type=TaskType.SEMANTIC_SEG,
        caption=False, conversations=False, grounding=False,
        target_export="COCO-seg",
    ),
    AnnotationPreset(
        id="instance_seg",
        display_name="实例分割",
        description="多边形实例分割,导出为 COCO-seg",
    ...
    AnnotationPreset(
        id="keypoint",
        display_name="关键点检测",
        description="点 + 锚框,导出为 COCO-keypoints",
        task_type=TaskType.KEYPOINT,
        caption=False, conversations=False, grounding=False,
        target_export="COCO-keypoints",
    ),
    AnnotationPreset(
        id="oriented_dota",
        display_name="旋转框检测 · DOTA",
        description="多边形旋转框,导出为 DOTA",
