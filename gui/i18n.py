...
STRINGS: dict[str, dict[str, str]] = {
    "zh": {
        ...
        "pager.page_of": "/ {n}",
        # Readiness chips
        "readiness.item.images": "图片",
        "readiness.item.classes": "分类",
        "readiness.item.labeled": "标注",
        "readiness.item.balance": "平衡",
        "readiness.item.minimum": "最少",
        "readiness.value.images": "{n:,}",
        "readiness.value.classes": "{n}",
        "readiness.value.labeled": "{pct:.0%}",
        "readiness.value.balance": "{ratio:.1f}:1",
        "readiness.value.minimum": "{n}",
        "readiness.action.import_images": "导入图片",
        "readiness.action.unlabeled": "{n} 张未标注",
        "readiness.action.imbalance": "最大/最小 = {ratio:.0f}:1",
        "readiness.action.min_class": "「{cat}」仅 {n} 张",
    },
    "en": {
        "nav.home": "Home",
        ...
        "pager.page_of": "of {n}",
        "readiness.item.images": "Images",
        "readiness.item.classes": "Classes",
        "readiness.item.labeled": "Labeled",
        "readiness.item.balance": "Balance",
        "readiness.item.minimum": "Min",
        "readiness.value.images": "{n:,}",
        "readiness.value.classes": "{n}",
        "readiness.value.labeled": "{pct:.0%}",
        "readiness.value.balance": "{ratio:.1f}:1",
        "readiness.value.minimum": "{n}",
        "readiness.action.import_images": "Import images",
        "readiness.action.unlabeled": "{n} unlabeled",
        "readiness.action.imbalance": "Max/Min = {ratio:.0f}:1",
        "readiness.action.min_class": "{cat}: only {n}",
    },
}
